    ...
    <motion.main className="min-h-screen overflow-hidden text-[#1f2428]" style={{ backgroundColor: pageBg }}>
      ...
      <section id="sobre-mi" className="relative overflow-hidden bg-[#fffaf2] px-5 py-16 text-[#1f2428] sm:px-8">
        ...
        <Image
          ...
          loading="lazy"
          className="pointer-events-none absolute bottom-0 right-[-1.25rem] z-20 hidden h-auto select-none opacity-95 drop-shadow-[0_18px_30px_rgba(31,36,40,.2)] lg:block lg:w-[clamp(250px,22vw,360px)] xl:right-0"
        />
        ...
        <Image
          ...
          sizes="180px"
          loading="lazy"
          className="relative z-20 mx-auto mt-8 h-auto w-44 select-none drop-shadow-[0_18px_30px_rgba(31,36,40,.2)] lg:hidden"
        />
      </section>
      ...
      <section id="stack" className="relative overflow-hidden bg-[#99b4aa] px-5 py-20 sm:px-8">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute bottom-0 right-[-1.5rem] z-20 hidden h-auto select-none opacity-95 drop-shadow-[0_18px_30px_rgba(31,36,40,.18)] lg:block lg:w-[clamp(250px,22vw,360px)] lg:drop-shadow-[0_24px_42px_rgba(31,36,40,.18)] xl:right-0"
        />
      ...
      <section id="experiencia" className="relative overflow-hidden bg-[#e1b8a2] px-5 py-20 sm:px-8">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute bottom-0 right-[-1.5rem] z-20 hidden h-auto select-none opacity-95 drop-shadow-[0_18px_30px_rgba(31,36,40,.18)] lg:block lg:w-[clamp(280px,23vw,400px)] lg:drop-shadow-[0_28px_48px_rgba(31,36,40,.18)] xl:right-0"
        />
        <div className="relative z-30 mx-auto max-w-[1180px] lg:pr-[13rem] xl:pr-[15rem]">
          ...
          <img
            ...
            alt=""
            aria-hidden="true"
            className="relative z-20 mx-auto mt-8 h-auto w-48 select-none drop-shadow-[0_18px_30px_rgba(31,36,40,.18)] lg:hidden"
          />
        </div>
      </section>
      ...
      <section id="certificaciones" className="relative overflow-hidden bg-[#99b4aa] px-5 py-20 sm:px-8">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute bottom-0 right-[-1rem] z-20 hidden h-auto select-none opacity-95 drop-shadow-[0_18px_30px_rgba(31,36,40,.18)] lg:block lg:w-[clamp(250px,21vw,340px)] lg:drop-shadow-[0_24px_42px_rgba(31,36,40,.2)] xl:right-2"
        />
